...
| 2026-09-18 | 14:52 | 15:38 | 46 min | Codex (`/root`) | ontwerp, schrijven en beheer | Project ingericht voor zelfgeschreven Rust-compiler met eigen bytecode/VM én directe Wasm-backend; README, bibliotheekbeleid, taalconcept, testplan en 80-uursbegroting gemaakt; Luna-werk gecoördineerd; PR geopend. | [sessie](docs/pws/werklog/2026-09-18-1452-projectinrichting.md), [README](README.md), [PR #4](https://github.com/geinigegastcoding/N-Lang/pull/4) | Links, PWS-metadata, bronpaden en 80-uursoptelling gecontroleerd; branch-diffcheck geslaagd; bewust geen compilerimplementatie of runtime-tests. | Leerlingen starten met eigen Cargo-project en tokens; open ontwerp- en onderzoekseisen bespreken. |
