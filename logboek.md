...
Tijden gebruiken de lokale tijd van de uitvoerder in het 24-uursformaat. Noteer de numerieke UTC-offset apart, zodat sessies van verschillende computers en locaties vergelijkbaar blijven. Eerdere regels worden niet stilzwijgend aangepast; een correctie krijgt een eigen gedateerde toelichting.
...
- **2026-09-18 — administratieve normalisatie:** de interne taakpad-identificatie bij de eerste Codex-sessie is vervangen door de draagbare rolnaam `hoofdagent`. Tijden, activiteiten en resultaten zijn niet gewijzigd.
